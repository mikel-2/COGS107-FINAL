"""
Signal Detection Theory (SDT) and Delta Plot Analysis for Response Time Data MODI-PY-D Version

This new .py file will include the new hierarchical model to quantify stimulus type/difficulty
"""
